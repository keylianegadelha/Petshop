  ...
  <body>
    <div>
      <ul class='nav'>
        ...
        <div>
          <h1 id='h1'>PetLove</h1>
          <p class='p' id='pPri'>Trabalhamos com amor e </p>
          <p class='p' id='pSeg'>dedicação total aos animais.</p>
          <img id='gato' src='icon/teste2.jpg'>
        </div>
         
         <p id='apresentacao'>Nossos serviços e produtos são feitos com qualidade, inovação e muito amor.</p>
         <p id='apresentacao1'>SEMPRE RESPEITANDO O BEM ESTAR ANIMAL.</p>
